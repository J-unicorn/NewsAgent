...
def get_impacton_data(driver=None, days_to_scrape=1, max_items=None, global_seen_links=None):
...
if __name__ == "__main__":
    data = get_impacton_data(days_to_scrape=1, max_items=20)
    print(f"\n수집: {len(data)}건")
